...
data_root = '/data/wx/dataset/cityscapes/'
data = dict(
            samples_per_gpu=2,
            workers_per_gpu=4,
            train=dict(
                        ...
                        source=dict(
                            type='SynthiaDataset',
                            data_root='/data/wx/dataset/synthia/RAND_CITYSCAPES/',
                            img_dir='RGB',
...
evaluation = dict(
    ...
    gt_dir="/data/wx/dataset/cityscapes/gtFine/val",
    gt_dir_panop="/data/wx/dataset/cityscapes/gtFine_panoptic",
